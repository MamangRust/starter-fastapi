...
from repository.abstract_class.slider_abstract import SliderAbstractRepository
from database.models.slider import Slider
from domain.requests.slider.create import CreateSliderRequest
from domain.requests.slider.update import UpdateSliderRequest
