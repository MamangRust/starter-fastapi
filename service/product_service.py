...
from domain.requests.product import create, update
from repository.abstract_class.product_abstract import ProductAbstractRepository
from service.abstract_class.product_abstract import ProductAbstractService
